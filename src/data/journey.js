  ...
  brazil2026: {
    ...
    matches: [
      ...
      },
      {
        ...
        teamKey: null,
        simulated: true,
        mood: 'Mata-mata. Quem perder vai embora — não importa quão grande seja o nome.',
      },
      {
        id: 5,
        stage: 'Quarterfinal',
        ...
        teamKey: null,
        simulated: true,
        mood: 'O caldeirão de Seattle. Quartas de final — quatro vitórias separam a campanha do troféu.',
      },
      {
        id: 6,
        stage: 'Semifinal',
